...
recipes = Recipe.create([
  ...
  {name: 'Tomato Bacon Grilled Cheese', instructions: '1. Place bacon in a large, deep skillet. Cook over medium high heat until evenly brown. Drain, and set aside. 2. Heat a large skillet over medium heat. Spread butter onto one side of each slice of bread. Lay 4 slices of bread, butter side down, in the skillet. Top with a slice of cheese, 2 slices tomato, bacon, and another slice of cheese. Cover with a slice of bread, butter side out. Fry sandwiches until golden on both sides.', calories: 557, author_id: 6},
  {name: 'Black Bean and Corn Quesadillas', instructions: '1. Heat oil in a large saucepan over medium heat. Stir in onion, and cook until softened, about 2 minutes. Stir in beans and corn, then add sugar, salsa, and pepper flakes; mix well. Cook until heated through, about 3 minutes. 2. Melt 2 teaspoons of the butter in a large skillet over medium heat. Place a tortilla in the skillet, sprinkle evenly with cheese, then top with some of the bean mixture. Place another tortilla on top, cook until golden, then flip and cook on the other side. Melt more butter as needed, and repeat with remaining tortillas and filling.', calories: 363, author_id: 7},
  {name: 'Tortellini Bacon Broccoli Salad', instructions: '1. Cook the tortellini according to the package directions, drain, rinse with cold water, and refrigerate until cool, about 30 minutes. 2. Place the bacon in a large, deep skillet, and cook over medium-high heat, turning occasionally, until evenly browned, about 10 minutes. Drain the bacon slices on a paper towel-lined plate. Chop the bacon into 1/2-inch pieces while still a little warm. 3. Place the tortellini, bacon, broccoli, grape tomatoes, and green onions into a salad bowl. Pour the dressing over the ingredients, and toss lightly to coat. Chill in refrigerator before serving.', calories: 349, author_id: 8},
  {name: 'Best Cream Of Broccoli Soup', instructions: '1. Melt 2 tablespoons butter in medium sized stock pot, and saute onion and celery until tender. Add broccoli and broth, cover and simmer for 10 minutes. 2. Pour the soup into a blender, filling the pitcher no more than halfway full. Hold down the lid of the blender with a folded kitchen towel, and carefully start the blender, using a few quick pulses to get the soup moving before leaving it on to puree. Puree in batches until smooth and pour into a clean pot. Alternately, you can use a stick blender and puree the soup right in the cooking pot. 3. In small saucepan, over medium-heat melt 3 tablespoons butter, stir in flour and add milk. Stir until thick and bubbly, and add to soup. Season with pepper and serve.', calories: 207, author_id: 9},
  {name: 'Black Bean and Couscous Salad', instructions: '1. Bring chicken broth to a boil in a 2 quart or larger sauce pan and stir in the couscous. Cover the pot and remove from heat. Let stand for 5 minutes. 2. In a large bowl, whisk together the olive oil, lime juice, vinegar and cumin. Add green onions, red pepper, cilantro, corn and beans and toss to coat. 3. Fluff the couscous well, breaking up any chunks. Add to the bowl with the vegetables and mix well. Season with salt and pepper to taste and serve at once or refrigerate until ready to serve.', calories: 255, author_id: 10},
  {name: 'Purple Kale Salad', instructions: "In a large bowl, toss the salad greens with the blueberries, walnuts, and raspberry vinaigrette. Top with feta cheese to serve.", calories: 128, author_id: 1},
  {name: 'Chimichurri Marinated Skirt Steak', instructions: '1. Spread each slice of bread with thousand island dressing. Top 4 of the bread slices with sauerkraut, cheese and pastrami. Place remaining bread slices on sandwich. Spread margarine on the outsides of each sandwich. 2. Heat a large skillet over medium high heat. Grill until browned, then turn and grill until heated through, and cheese is melted.', calories: 198, author_id: 2},
  {name: 'Potato Gnocchi', instructions: '1. Stir shrimp, olive oil, cilantro, lime juice, garlic, tequila, cayenne pepper, and salt together in a bowl. Cover the bowl with plastic wrap and refrigerate shrimp in marinade for 30 minutes. 2. Preheat an outdoor grill for high heat and lightly oil grate. 3. Remove shrimp from bowl and thread onto skewers; discard marinade. 4. Cook on the preheated grill until shrimp turn pink, 2 to 3 minutes per side.', calories: 188, author_id: 3},
  {name: 'Crisp Rosemary-Ghee Potatoes', instructions: 'In a 3 1/2 quart or larger slow cooker combine the lentils, celery, carrots, onion, garlic and ham. Season with basil, thyme, oregano, the bay leaf and pepper. Stir in the chicken broth, water and tomato sauce. Cover and cook on Low for 11 hours. Discard the bay leaf before serving.', calories: 222, author_id: 4},
  {name: 'Avacado Everything Bagel', instructions: '1. Place egg in a saucepan and cover with cold water. Bring water to a boil and immediately remove from heat. Cover and let eggs stand in hot water for 10 to 12 minutes. Remove from hot water, cool, peel and chop. 2.Place the chopped eggs in a bowl, and stir in the mayonnaise, mustard and green onion. Season with salt, pepper and paprika. Stir and serve on your favorite bread or crackers.', calories: 344, author_id: 1},
  {name: 'Country Ham Biscuit with Fig Jam', instructions: '1. Place bacon in a large, deep skillet. Cook over medium high heat until evenly brown. Drain, and set aside. 2. Heat a large skillet over medium heat. Spread butter onto one side of each slice of bread. Lay 4 slices of bread, butter side down, in the skillet. Top with a slice of cheese, 2 slices tomato, bacon, and another slice of cheese. Cover with a slice of bread, butter side out. Fry sandwiches until golden on both sides.', calories: 557, author_id: 6},
  ])
...
recipe_ingredients = RecipeIngredient.create([
  ...
  {recipe_id: 6, ingredient_id: 3, quantity_amount: '8', quantity_type: 'slices'},
  {recipe_id: 6, ingredient_id: 79, quantity_amount: '1/4', quantity_type: 'cup'},
  {recipe_id: 6, ingredient_id: 269, quantity_amount: '8', quantity_type: 'slices'},
  {recipe_id: 6, ingredient_id: 88, quantity_amount: '8', quantity_type: 'slices'},
  {recipe_id: 6, ingredient_id: 41, quantity_amount: '8', quantity_type: 'slices'},
  {recipe_id: 7, ingredient_id: 272, quantity_amount: '2', quantity_type: 'teaspoons'},
  {recipe_id: 7, ingredient_id: 39, quantity_amount: '3', quantity_type: 'teaspoons'},
  {recipe_id: 7, ingredient_id: 323, quantity_amount: '1', quantity_type: 'can'},
  {recipe_id: 7, ingredient_id: 51, quantity_amount: '1', quantity_type: 'can'},
  {recipe_id: 7, ingredient_id: 292, quantity_amount: '1', quantity_type: 'tablespoon'},
  {recipe_id: 7, ingredient_id: 146, quantity_amount: '1/4', quantity_type: 'teaspoon'},
  {recipe_id: 7, ingredient_id: 79, quantity_amount: '2', quantity_type: 'teaspoons'},
  {recipe_id: 7, ingredient_id: 238, quantity_amount: '8', quantity_type: 'slices'},
  {recipe_id: 7, ingredient_id: 93, quantity_amount: '1 1/2', quantity_type: 'cups'},
  {recipe_id: 8, ingredient_id: 225, quantity_amount: '2', quantity_type: 'packs'},
  {recipe_id: 8, ingredient_id: 3, quantity_amount: '1', quantity_type: 'pound'},
  {recipe_id: 8, ingredient_id: 54, quantity_amount: '4', quantity_type: 'cups'},
  {recipe_id: 8, ingredient_id: 41, quantity_amount: '1', quantity_type: 'pint'},
  {recipe_id: 8, ingredient_id: 39, quantity_amount: '2', quantity_type: 'cups'},
  {recipe_id: 8, ingredient_id: 361, quantity_amount: '1', quantity_type: 'cups'},
  {recipe_id: 9, ingredient_id: 79, quantity_amount: '2', quantity_type: 'tablespoon'},
  {recipe_id: 9, ingredient_id: 39, quantity_amount: '1', quantity_type: 'chopped'},
  {recipe_id: 9, ingredient_id: 57, quantity_amount: '1', quantity_type: 'stalk'},
  {recipe_id: 9, ingredient_id: 363, quantity_amount: '3', quantity_type: 'cups'},
  {recipe_id: 9, ingredient_id: 54, quantity_amount: '8', quantity_type: 'cups'},
  {recipe_id: 9, ingredient_id: 79, quantity_amount: '3', quantity_type: 'tablespoons'},
  {recipe_id: 9, ingredient_id: 223, quantity_amount: '3', quantity_type: 'tablespoons'},
  {recipe_id: 9, ingredient_id: 81, quantity_amount: '2', quantity_type: 'cups'},
  {recipe_id: 10, ingredient_id: 248, quantity_amount: '1', quantity_type: 'cup'},
  {recipe_id: 10, ingredient_id: 363, quantity_amount: '1 1/4', quantity_type: 'cups'},
  {recipe_id: 10, ingredient_id: 272, quantity_amount: '3', quantity_type: 'teaspoons'},
  {recipe_id: 10, ingredient_id: 315, quantity_amount: '2', quantity_type: 'teaspoons'},
  {recipe_id: 10, ingredient_id: 39, quantity_amount: '8', quantity_type: 'chopped'},
  {recipe_id: 10, ingredient_id: 49, quantity_amount: '1', quantity_type: 'chopped'},
  {recipe_id: 10, ingredient_id: 48, quantity_amount: '1/4', quantity_type: 'chopped'},
  {recipe_id: 10, ingredient_id: 51, quantity_amount: '1', quantity_type: 'cup'},
  {recipe_id: 10, ingredient_id: 323, quantity_amount: '2', quantity_type: 'cans'},
  {recipe_id: 11, ingredient_id: 44, quantity_amount: '1 (10 ounce)', quantity_type: 'package'},
  {recipe_id: 11, ingredient_id: 117, quantity_amount: '1', quantity_type: 'pint'},
  {recipe_id: 11, ingredient_id: 333, quantity_amount: '1/4', quantity_type: 'cup'},
  {recipe_id: 11, ingredient_id: 94, quantity_amount: '1/4', quantity_type: 'cup'},
  {recipe_id: 12, ingredient_id: 79, quantity_amount: '2', quantity_type: 'tablespoon'},
  {recipe_id: 12, ingredient_id: 268, quantity_amount: '8', quantity_type: 'slices'},
  {recipe_id: 12, ingredient_id: 30, quantity_amount: '8', quantity_type: 'slices'},
  {recipe_id: 13, ingredient_id: 278, quantity_amount: '1', quantity_type: 'pound'},
  {recipe_id: 13, ingredient_id: 271, quantity_amount: '3', quantity_type: 'tablespoon'},
  {recipe_id: 13, ingredient_id: 58, quantity_amount: '3', quantity_type: 'tablespoon'},
  {recipe_id: 13, ingredient_id: 1, quantity_amount: '2', quantity_type: 'tablespoon'},
  {recipe_id: 13, ingredient_id: 38, quantity_amount: '2', quantity_type: 'cloves'},
  {recipe_id: 13, ingredient_id: 152, quantity_amount: '1/4', quantity_type: 'teaspoon'},
  {recipe_id: 13, ingredient_id: 1, quantity_amount: '1/4', quantity_type: 'teaspoon'},
  {recipe_id: 14, ingredient_id: 320, quantity_amount: '1', quantity_type: 'cup'},
  {recipe_id: 14, ingredient_id: 56, quantity_amount: '1', quantity_type: 'cup'},
  {recipe_id: 14, ingredient_id: 43, quantity_amount: '1', quantity_type: 'cup'},
  {recipe_id: 14, ingredient_id: 39, quantity_amount: '1', quantity_type: 'cup'},
  {recipe_id: 14, ingredient_id: 38, quantity_amount: '2', quantity_type: 'cloves'},
  {recipe_id: 14, ingredient_id: 5, quantity_amount: '1 1/2', quantity_type: 'cup'},
  {recipe_id: 14, ingredient_id: 45, quantity_amount: '1/2', quantity_type: 'teaspoon'},
  {recipe_id: 14, ingredient_id: 156, quantity_amount: '1/2', quantity_type: 'teaspoon'},
  {recipe_id: 14, ingredient_id: 150, quantity_amount: '1/4', quantity_type: 'teaspoon'},
  {recipe_id: 14, ingredient_id: 162, quantity_amount: '1', quantity_type: ''},
  {recipe_id: 14, ingredient_id: 1, quantity_amount: '1/4', quantity_type: 'teaspoon'},
  {recipe_id: 14, ingredient_id: 1, quantity_amount: '32', quantity_type: 'ounces'},
  {recipe_id: 14, ingredient_id: 1, quantity_amount: '1', quantity_type: 'cup'},
  {recipe_id: 14, ingredient_id: 350, quantity_amount: '8', quantity_type: 'teaspoon'},
  {recipe_id: 15, ingredient_id: 80, quantity_amount: '8', quantity_type: 'single'},
  {recipe_id: 15, ingredient_id: 341, quantity_amount: '1/2', quantity_type: 'cup'},
  {recipe_id: 15, ingredient_id: 39, quantity_amount: '1/4', quantity_type: 'cup'},
  {recipe_id: 15, ingredient_id: 151, quantity_amount: '1/4', quantity_type: 'teaspoon'},
  {recipe_id: 16, ingredient_id: 3, quantity_amount: '8', quantity_type: 'slices'},
  {recipe_id: 16, ingredient_id: 79, quantity_amount: '1/4', quantity_type: 'cup'},
  {recipe_id: 16, ingredient_id: 269, quantity_amount: '8', quantity_type: 'slices'},
  {recipe_id: 16, ingredient_id: 88, quantity_amount: '8', quantity_type: 'slices'},
  {recipe_id: 16, ingredient_id: 41, quantity_amount: '8', quantity_type: 'slices'}
  ])
